...
st.write(f"**_Model's Accuracy_** :  :green[**{accuracy}**]% (:red[© Copyright Satria Yudha])")
st.write("")
...
with tab1:
  ...
  trestbps = st.sidebar.number_input(label=":violet[**Resting Blood Presure** (in mm Hg on admission to the hospital)]", min_value=df_final['trestbps'].min(), max_value=df_final['trestbps'].max())
